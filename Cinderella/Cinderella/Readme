...
2) must use a technology, language or platform not delivered as part of NBCC’s ITPA regular curriculum;
...
Cinderella is a software that will distribute the rooms in the best possible way to the employees, in order to guarantee the maximum balance of the workload among all the attendants. It has only two goals: Improve housekeepers quality of life and save money to company (WIN-WIN).
